...
\begin{figure}[htb]
\centering
\includegraphics[width=0.5\textwidth]{./imagenes/cupula}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.7\textwidth]{./imagenes/opticaAdaptativa}
\caption{Óptica Adaptativa (http://astrocity.es/)} \label{fig:opticaAdaptativa}
\end{figure}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.5\textwidth]{./imagenes/estacionMeteorologica}
...
\section{Estado del arte: \textit{Software}}
